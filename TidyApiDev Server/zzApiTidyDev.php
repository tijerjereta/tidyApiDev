  ...
  <!-- <div id="primary" class="content-area"> -->
    ...
    <?php
      ...
      curl_setopt_array($curl, array(
        CURLOPT_URL => "https://benefootwear3.tidystock.com//api/materialitems?IncludeImages=True",
                        //https://benefootwear3.tidystock.com//api/materialitems?IncludeImages=True&IncludePricing=True
      ...
      if ($err) {
        if ($debug) echo "cURL Error #:" . $err;
            ...
            $arrayProductCode = [];
            $stockStatusArray = [];
            for( $i = 0; $i <260 /*$canProd*/; $i++ ) {
                /* LOGICA WOOCOMMERCE =====================*/ 
                // PRUEBA CONSULTA TABLA DE PRODUCTOS WOOCOMMERCE: Si el Nombre y la Descripcion estan en la base de datos, y si el producto esta en estado publicado. 
                ...
                // print_r($producto[$i])
                // $pricing = $producto[$i]['pricing'];
                // echo "PRICING: ".$pricing."<br><br><br>";
                // print_r($pricing);
                // echo "<br><br><br>";
...
//                                     }
                        ...
                        // EN RESET VARIATIONS AND ATTRIBUTES //
                    }      
                }else{
